    ...
    <div className="ribbon-group">
      <div className="ribbon-section">
        <div className="ribbon-tools">
          ...
          <button
            className={`ribbon-btn ${currentTool === "selection" ? "active" : ""}`}
      ...
      <div className="ribbon-section">
        <div className="ribbon-tools tool-grid-ribbon">
          <button
            className={`ribbon-btn ${currentTool === "pencil" ? "active" : ""}`}
          ...
          <button
            className={`ribbon-btn ${currentTool === "fill" ? "active" : ""}`}
          ...
          <button
            className={`ribbon-btn ${currentTool === "text" ? "active" : ""}`}
          ...
          <button
            className={`ribbon-btn ${currentTool === "eraser" ? "active" : ""}`}
          ...
          <button
            className={`ribbon-btn ${currentTool === "eyedropper" ? "active" : ""}`}
      ...
      <div className="ribbon-section">
        <div className="ribbon-tools">
          <button
            className={`ribbon-btn large ${
              currentTool === "brush" && brushType === "normal" ? "active" : ""
            }`}
            onClick={() => {
          ...
          <button
            className={`ribbon-btn large ${
              currentTool === "brush" && brushType === "spray" ? "active" : ""
            }`}
            onClick={() => {
              setCurrentTool("brush");
              setBrushType("spray");
      ...
      <div className="ribbon-section">
        <div className="ribbon-tools shape-grid">
          <button
            className={`ribbon-btn ${currentTool === "line" ? "active" : ""}`}
            onClick={() => setCurrentTool("line")}
          >
            <Minus size={18} />
          </button>
          <button
            className={`ribbon-btn ${currentTool === "rect" ? "active" : ""}`}
            onClick={() => setCurrentTool("rect")}
          >
            <Square size={18} />
          </button>
          <button
            className={`ribbon-btn ${currentTool === "ellipse" ? "active" : ""}`}
            onClick={() => setCurrentTool("ellipse")}
          >
            <Circle size={18} />
          </button>
          <button
            className={`ribbon-btn ${currentTool === "triangle" ? "active" : ""}`}
