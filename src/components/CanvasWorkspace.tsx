...
const CanvasWorkspace: React.FC<CanvasWorkspaceProps> = ({
  ...
  useEffect(() => {
    ...
    const init = () => {
      ...
      // Snapshot existing content before resize
  ...
  const getCursorStyle = () => {
    ...
    if (currentTool === "selection")
      return selection?.imageCanvas ? "crosshair" : "crosshair"; // ideally change based on hover over handles/box, keeping simple for now
